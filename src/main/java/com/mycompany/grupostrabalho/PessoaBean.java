...
//</editor-fold>
    ...
    public List<Object[]> buscarDataMembroGrupos(Long idGrupo, LocalDate dataInicio){
        return (List<Object[]>)entityManager.createQuery("SELECT new com.mycompany.grupostrabalho.MembroDto(a.grupo.nome, a.inicio, a.pessoa.nome) FROM Atuacao a WHERE a.grupo.id = :idGrupo AND a.inicio >= :dataInicio ORDER BY a.grupo.nome, a.inicio")
                .setParameter("idGrupo", idGrupo).setParameter("dataInicio", dataInicio).getResultList();
    } 
    @Override
    public List<Object[]> buscarDataMembroGrupos(LocalDate dataInicio){
        return (List<Object[]>)entityManager.createQuery("SELECT new com.mycompany.grupostrabalho.MembroDto(a.grupo.nome, a.inicio, a.pessoa.nome) FROM Atuacao a WHERE a.inicio >= :dataInicio ORDER BY a.grupo.nome, a.inicio")
